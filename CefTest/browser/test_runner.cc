   ...
   public:
    ...
    virtual void Visit(const CefString& string) OVERRIDE {
      ...
      ss << "<html><body bgcolor=\"white\">Source:<pre>" << source
         << "</pre></body></html>";
      browser_->GetMainFrame()->LoadString(ss.str(), "http://getsource");
    }
   ...
   public:
    ...
    virtual void Visit(const CefString& string) OVERRIDE {
      ...
      ss << "<html><body bgcolor=\"white\">Text:<pre>" << text
         << "</pre></body></html>";
      browser_->GetMainFrame()->LoadString(ss.str(), "http://gettext");
    }
  ...
  class Visitor : public CefWebPluginInfoVisitor {
   public:
    ...
    ~Visitor() {
      ...
      browser_->GetMainFrame()->LoadString(html_, "http://plugin_info");
    }
...
void RunOtherTests(CefRefPtr<CefBrowser> browser) {
  browser->GetMainFrame()->LoadURL("http://other_tests");
}
